...
<?php while (have_posts()) :
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row text-center justify-content-start">
                    ...
                    $speakers = $wpdb->get_results("SELECT * FROM $table WHERE category_id NOT IN ('20','10;20','20;10') ORDER BY speaker_family_name");
            ...
            <!-- SYNCLOGIC SPEAKERS cat 12 LOOP TEMPLATE -->
            <div class="container">
                <div class="row text-center">
                    <div class="col-12 col-sm-12">
                        <?php if(get_field('speakers_second_section_title')) { ?>
                            <h3> <?php the_field('speakers_second_section_title'); ?> </h3>
                            <hr>
                        <?php } ?>
                    </div>

                    <div class="col-12 col-sm-12">
                        <?php the_field('speakers_second_section_sub-title'); ?>
                    </div>
                </div>
                ...
                <div class="row text-center justify-content-start">
                    <?php
                    $table = $wpdb->base_prefix."synclogic_speakers";
                    $speakers = $wpdb->get_results("SELECT * FROM $table WHERE category_id IN ('20','10;20','20;10') ORDER BY speaker_family_name");
    ...
    <div id="speakers-three">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <h3 class="text-center"><?php the_field('speakers_section_2_title'); ?></h3>
                    <div> <?php the_field('speakers_section_2_sub-title'); ?> </div>
                </div>
            </div>
            ...
            <div class="row text-center">
                <div class="col-12 col-sm-12">
                    <?php
                    $link = get_field('speakers_section_2_link');
                    if($link) { ?>
